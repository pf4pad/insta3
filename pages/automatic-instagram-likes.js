                        ...
                        <div className={`container`}>
                            ...
                            <div className={styles.phone}>
                                ...
                                <div className={buyLikesStyles.mainTitle}>
                                    <p className={buyLikesStyles.title}>AUTOMATIC <br/>INSTAGRAM LIKES</p>
                            ...
                            <div style={{display:'flex',flexDirection:'row',alignItems:'center'}}>
                                ...
                                <div className={buyLikesStyles.buyLikes_item_container}>
                                        ...
                                        {price["Auto-Likes"]?.plans.map((item,index) => <BuyLikes key={item?.count} likes={item?.count} newPrice={item?.price}
                                                                                           color="#285FFF" text="Real Instagram Auto-Likes" type={"instagram"}
                                                                                           onClick={() => {
                                                                                               router.push({
                                                                                                   pathname: '/basket',
