    ...
    return (
        <div className={styles.background} style={{background:"url('/youtubeBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy YouTube likes from MakeTop . Instant delivery, real likes and friendly 24/7 customer support. Try us today."/>
                <meta name="description" content="Buy YouTube likes from MakeTop . Instant delivery, real auto likes and friendly 24/7 customer support. Try us today."/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy YouTubeLikes From The world's #1 Site (2022)- maketop"/>
                <meta name="twitter:card" content="summary"/>
                <meta name="twitter:description" content="Buy YouTube auto likes from MakeTop. Instant delivery, real auto likes and friendly 24/7 customer support. Try us today."/>
                <meta name="twitter:description" content="Buy YouTube  likes from MakeTop. Instant delivery, real  likes and friendly 24/7 customer support. Try us today."/>
                <meta name="twitter:title" content="Buy YouTube Auto Likes From The world's #1 Site (2022)- maketop"/>
                <meta name="twitter:title" content="Buy YouTube Likes From The world's #1 Site (2022)- maketop"/>
                    ...
                    <Layer type="youtube">
                        <div className={`container`}>
                            ...
                            <div className={styles.phone}>
                                <img src="/youtubePhoto.png" alt="" className={styles.youtubeImg} />
                            ...
                            <div style={{display:'flex',flexDirection:'row',alignItems:'center'}}>
                                ...
                                <div className={buyLikesStyles.buyLikes_item_container}>
                                        ...
                                        {additionalPrice?.map( (item,index)  => <BuyLikes key={item[0]} likes={item[0]} newPrice={item[1]}
                                                                                                                                text="Real YouTube Likes" type={"youtube"}
                                                                                                                                onClick={() => {
                                                                                                                                    router.push({
                                                                                                                                        pathname: '/basket',
                                                                                                                                        query: { service:'Likes',counts:item[0],system:"YouTube",priceValue:item[1] },
                                                                                                                                    } )
                            ...
                            <div className={buyLikesStyles.reviews_container}>
                                ...
                                {isReviewButtonPress&&<ModalReview open={isReviewButtonPress} setOpen={setIsReviewButtonPress} type="youtube" service="Likes"/>}
