...
const BuyTwitterLikes = () => {
    ...
    return (
        <div className={styles.background} style={{background:"url('/twitterBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy Twitter likes from MakeTop . Instant delivery, real likes and friendly 24/7 customer support. Try us today."/>
                <meta name="description" content="Buy Twitter auto likes from MakeTop . Instant delivery, real auto likes and friendly 24/7 customer support. Try us today."/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy Twitter   Likes From The world's #1 Site (2022)- maketop"/>
                <meta name="twitter:card" content="summary"/>
                <meta name="twitter:description" content="Buy Twitter   likes from MakeTop. Instant delivery, real auto likes and friendly 24/7 customer support. Try us today."/>
                <meta name="twitter:description" content="Buy Twitter  likes from MakeTop. Instant delivery, real  likes and friendly 24/7 customer support. Try us today."/>
                <meta name="twitter:title" content="Buy Twitter   Likes From The world's #1 Site (2022)- maketop"/>
                <meta name="twitter:title" content="Buy Twitter Likes From The world's #1 Site (2022)- maketop"/>
                <meta property="og:url" content="https://likes.io/buy-twitter-likes"/>
                <link rel="canonical" href="https://likes.io/buy-twitter-likes"/>
            </Head>
                        ...
                        <div className={`container`}>
                            ...
                            <div className={styles.phone2}>
                                ...
                                <div className={buyLikesStyles.secondTitle}>
                                    ...
                                    <ButtonComponent text={'Leave Feedback'} type={'twitter'}
                                                     onClick={()=>router.push("/")}
                                    />
                                </div>
                                <img src="/twitterPhoto1.png" alt="" className={styles.twitterImg1} />
                                <img src="/twitterPhoto2.png" alt=""  className={styles.twitterImg2} />
                            </div>
                            ...
                            <div style={{display:'flex',flexDirection:'row',alignItems:'center'}}>
                                {/*<div className={youtubeStyles.buyLikes_item_backButton} style={colors["twitter"].arrowButtonsColor}>*/}
                                ...
                                <div className={youtubeStyles.buyLikes_item_container}>
                                        ...
                                        {additionalPrice?.map( (item,index)  => <BuyLikes key={item[0]} likes={item[0]} newPrice={item[1]}
                                                                                          text="Real Twitter Likes" type={"twitter"}
                                                                                          onClick={() => {
                                                                                              router.push({
                                                                                                  pathname: '/basket',
                                                                                                  query: { service:'Likes',counts:item[0],system:"Twitter",priceValue:item[1] },
                                                                                              } )
                            ...
                            <div className={buyLikesStyles.reviews_container}>
                                {comment&&<ReviewsGenerator type="twitter" comment={comment}/>}
                                <OwnComment type="twitter" service="Likes"/>
                                {isReviewButtonPress&&<ModalReview open={isReviewButtonPress} setOpen={setIsReviewButtonPress} type="twitter" service="Likes"/>}
                                <span className={buyLikesStyles.ownHiddenButton}><ButtonComponent text={'Leave comment'} type={'twitter'}
                            ...
                            <div className={infoStyles.info_block}>
                                ...
                                {readTextMore&&<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.
                                    ...
                                    nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel
                                    augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus.</p>}
                                <a style={{color:"#02C6F8",textDecoration:"underline"}} onClick={()=>setReadTextMore(!readTextMore)}>{readTextMore?"Close":"Read more"}</a>
                            </div>
                        </div>
                    </Layer>
                </div>
