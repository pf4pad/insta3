    ...
    return (
        <div className={styles.background} style={{background:"url('tiktokBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy TikTok followers from MakeTop . Instant delivery, real followers and friendly 24/7 customer support. Try us today."/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy TikTok  Followers From The world's #1 Site (2022)- maketop"/>
                <meta name="twitter:card" content="summary"/>
                <meta name="twitter:description" content="Buy TikTok  followers from MakeTop. Instant delivery, real followers and friendly 24/7 customer support. Try us today."/>
                <meta name="twitter:title" content="Buy TikTok Followers From The world's #1 Site (2022)- maketop"/>
                <meta property="og:url" content="https://likes.io/buy-tiktok-followers"/>
                <link rel="canonical" href="https://likes.io/buy-tiktok-followers"/>
            </Head>
                ...
                <Layer type="tiktok">
                    <div className={`container`}>
                        ...
                        <div style={{display:'flex',flexDirection:'row',alignItems:'center'}}>
                            ...
                            <div className={youtubeStyles.buyLikes_item_container}>
                                    ...
                                    {additionalPrice?.map( (item,index)  => <BuyLikes key={item[0]} likes={item[0]} newPrice={item[1]}
                                                                                      text="Real TikTok Followers" type={"tiktok"}
                                                                                      onClick={() => {
                                                                                          router.push({
                                                                                              pathname: '/basket',
                                                                                              query: { service:'Followers',counts:item[0],system:"TikTok",priceValue:item[1] },
                                                                                          } )
                        ...
                        <div className={buyLikesStyles.reviews_container}>
                            ...
                            {isReviewButtonPress&&<ModalReview open={isReviewButtonPress} setOpen={setIsReviewButtonPress} type="tiktok" service="Followers"/>}
