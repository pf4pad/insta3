...
const BuySpotifyPlaylistFollowers = () => {
    ...
    return (
        <div className={styles.background} style={{background:"url('/spotifyBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy Spotify playlist followers from MakeTop . Instant delivery, real followers and friendly 24/7 customer support. Try us today."/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy Spotify playlist Followers From The world's #1 Site (2022)- maketop"/>
                <meta name="twitter:card" content="summary"/>
                <meta name="twitter:description" content="Buy Spotify playlist followers from MakeTop. Instant delivery, real followers and friendly 24/7 customer support. Try us today."/>
                <meta name="twitter:title" content="Buy Spotify playlist Followers From The world's #1 Site (2022)- maketop"/>
                <meta property="og:url" content="https://likes.io/buy-spotify-playlist-followers"/>
                <link rel="canonical" href="https://likes.io/buy-spotify-playlist-followers"/>
            </Head>
                    ...
                    <div className={`container`}>
                        ...
                        <div className={styles.phone2}>
                            <div className={buyLikesStyles.secondTitle}>
                                <p className={buyLikesStyles.title}>SPOTIFY PLAYLIST FOLLOWERS</p>
                                ...
                                />
                            </div> <img src="/spotifyPhoto.png" alt="" className={styles.spotifyImg} />
                        </div>
                        ...
                        <div style={{display:'flex',flexDirection:'row',alignItems:'center'}}>
                            {/*<div className={youtubeStyles.buyLikes_item_backButton} style={colors["spotify"].arrowButtonsColor}>*/}
                            ...
                            <div className={youtubeStyles.buyLikes_item_container}>
                                    ...
                                    {additionalPrice?.map( (item,index)  => <BuyLikes key={item[0]} likes={item[0]} newPrice={item[1]}
                                                                                      text="Spotify Playlist Followers" type={"spotify"}
                                                                                      onClick={() => {
                                                                                          router.push({
                                                                                              pathname: '/basket',
                                                                                              query: { service:'Followers',counts:item[0],system:"Spotify",priceValue:item[1] },
                                                                                          } )
                        ...
                        <div className={buyLikesStyles.reviews_container}>
                            {comment&&<ReviewsGenerator type="spotify" comment={comment}/>}
                            <OwnComment type="spotify" service="Followers"/>
                            {isReviewButtonPress&&<ModalReview open={isReviewButtonPress} setOpen={setIsReviewButtonPress} type="spotify" service="Followers"/>}
                            <span className={buyLikesStyles.ownHiddenButton}><ButtonComponent text={'Leave comment'} type={'spotify'}
                        ...
                        <div className={infoStyles.info_block}>
                            ...
                            {readTextMore&&<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.
                                ...
                                nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel
                                augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus.</p>}
                            <a style={{color:"#54DE80",textDecoration:"underline"}} onClick={()=>setReadTextMore(!readTextMore)}>{readTextMore?"Close":"Read more"}</a>
                        </div>
                    </div>
                </Layer>
            </div>
