    ...
    return (
        <div className={styles.background} style={{background:"url('instagramBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Free Instagram followers from MakeTop . Instant delivery, real followers and friendly 24/7 customer support. Try us today."/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Free Instagram Followers From The world's #1 Site (2022)- maketop"/>
                <meta name="twitter:card" content="summary"/>
                <meta name="twitter:description" content="Free Instagram followers from MakeTop. Instant delivery, real followers and friendly 24/7 customer support. Try us today."/>
                <meta name="twitter:title" content="Free Instagram Followers From The world's #1 Site (2022)- maketop"/>
                <meta property="og:url" content="https://likes.io/buy-instagram-followers"/>
                <link rel="canonical" href="https://likes.io/buy-instagram-followers"/>
            </Head>
                    ...
                    <div className={`container`}>
                        ...
                        <div className={styles.phone}>
                            ...
                            <div className={buyLikesStyles.mainTitle}>
                                <p className={buyLikesStyles.title}>FREE INSTAGRAM FOLLOWERS</p>
                                ...
                                <ButtonComponent text={'Free 10 Instagram followers'} type={'instagram'} onClick={()=>
                                    router.push({
                                        pathname: '/basket',
                                        query: { service:'Followers',counts:counts,system:"Instagram",priceValue:priceValue },
                                    } )
                                }/>
                            </div>
                        </div>
                        ...
                        {isOpen&&
                            < ModalComponent open={isOpen} setOpen={setIsOpen} service="Followers" counts={counts} priceValue={priceValue} system="Instagram"/>}
                        ...
                        <div style={{display:'flex',flexDirection:'row',alignItems:'center'}}>
                            ...
                            <div className={buyLikesStyles.buyLikes_item_container}>
                                    ...
                                    {price?.Followers?.plans.map((item,index) => <BuyLikes key={item?.count} likes={item?.count} newPrice={item?.price}
                                                                                           color="#285FFF" text="Real Instagram Followers" type={"instagram"}
                                                                                           onClick={() => {
                                                                                               router.push({
                                                                                                   pathname: '/basket',
                                                                                                   query: { service:'Followers',counts:item?.count,system:"Instagram",priceValue:item?.price },
                                                                                               } )
                        ...
                        <div className={buyLikesStyles.reviews_container}>
                            ...
                            {isReviewButtonPress&&<ModalReview open={isReviewButtonPress} setOpen={setIsReviewButtonPress} type="instagram" service="Followers"/>}
