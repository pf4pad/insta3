    ...
    return (
        <div className={styles.background} style={{background:"url('instagramBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Free Instagram likes from MakeTop . Instant delivery, real likes and friendly 24/7 customer support. Try us today."/>
                <meta name="description" content="Free Instagram auto likes from MakeTop . Instant delivery, real auto likes and friendly 24/7 customer support. Try us today."/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Free Instagram Auto Likes From The world's #1 Site (2022)- maketop"/>
                <meta name="twitter:card" content="summary"/>
                <meta name="twitter:description" content="Free Instagram auto likes from MakeTop. Instant delivery, real auto likes and friendly 24/7 customer support. Try us today."/>
                <meta name="twitter:description" content="Free Instagram  likes from MakeTop. Instant delivery, real  likes and friendly 24/7 customer support. Try us today."/>
                <meta name="twitter:title" content="Free Instagram Auto Likes From The world's #1 Site (2022)- maketop"/>
                <meta name="twitter:title" content="Free Instagram  Likes From The world's #1 Site (2022)- maketop"/>
                    ...
                    <div className={`container`}>
                        ...
                        <div className={styles.phone}>
                            ...
                            <div className={buyLikesStyles.mainTitle}>
                                ...
                                <ButtonComponent text={'Free 10 Instagram likes'} type={'instagram'} onClick={()=>{
                                    router.push({
                                        pathname: '/basket',
                                        query: { service:'Likes',counts:counts,system:"Instagram",priceValue:priceValue },
                                    } )
                                }}/>
                            </div>
                        </div>
