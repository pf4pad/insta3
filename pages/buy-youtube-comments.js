    ...
    return (
        <div className={styles.background} style={{background:"url('/youtubeBg.png') no-repeat 100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy YouTube comments from MakeTop . Instant delivery, real comments and friendly 24/7 customer support. Try us today."/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy YouTube Comments From The world's #1 Site (2022)- maketop"/>
                <meta name="twitter:card" content="summary"/>
                <meta name="twitter:description" content="Buy YouTube comments from MakeTop. Instant delivery, real comments and friendly 24/7 customer support. Try us today."/>
                <meta name="twitter:title" content="Buy YouTube Comments From The world's #1 Site (2022)- maketop"/>
                <meta name="twitter:site" content="@StormlikesN"/>
                <meta property="og:url" content="https://likes.io/buy-youtube-comments"/>
                    ...
                    <Layer type="youtube">
                        <div className={`container`}>
                            ...
                            <div style={{display:'flex',flexDirection:'row',alignItems:'center'}}>
                                ...
                                <div className={buyLikesStyles.buyLikes_item_container}>
                                        ...
                                        {additionalPrice?.map( (item,index)  => <BuyLikes key={item[0]} likes={item[0]} newPrice={item[1]}
                                                                                          text="Real YouTube Comments" type={"youtube"}
                                                                                          onClick={() => {
                                                                                              router.push({
                                                                                                  pathname: '/basket',
                                                                                                  query: { service:'Comments',counts:item[0],system:"YouTube",priceValue:item[1] },
                                                                                              } )
                            ...
                            <div className={buyLikesStyles.reviews_container}>
                                ...
                                {isReviewButtonPress&&<ModalReview open={isReviewButtonPress} setOpen={setIsReviewButtonPress} type="youtube" service="Comments"/>}
