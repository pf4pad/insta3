...
import FreeModalPosts from "./FreeModal/FreeModalPosts";
...
export const ModalComponent = ({open,setOpen, counts, priceValue, system , service  }) => {
    ...
    const sendOrder = async() => {
        ...
        try {
            ...
            const res = axios.post(`${priceValue === '0.00' ? '/create_test_order_v2.php' : '/create_order_v2.php' }`, data)
            res.then((e) => {
            ...
            >
                {system === "Instagram" ?
                    <div className={styles.modal_container}>
                        ...
                        {priceValue === '0.00' ?
                            modal === 1 &&<FreeModalLogin modal={modal} setModal={setModal} setUserName={setUserName} userName={userName} service={service}/>:
                            modal === 1 &&
                            <ModalLogin modal={modal} setModal={setModal} counts={counts} priceValue={priceValue}
                                        service={service} setUserName={setUserName} userName={userName} system={system}/>}
                        {modal === 2 &&
                        priceValue === '0.00' ?
                            <FreeModalEmail
                                service={service} setUserEmail={setUserEmail} userEmail={userEmail}
                                getPosts={getPosts} errorMessage={errorMessage} />:
                            modal === 2 &&<ModalEmail modal={modal} setModal={setModal} counts={counts} priceValue={priceValue}
                                        service={service} setUserEmail={setUserEmail} userEmail={userEmail}
                                        getPosts={getPosts} errorMessage={errorMessage} system={system} isLoading={isLoading}/>}
                        {modal === 3 &&
                        priceValue === '0.00' ?
                            <FreeModalAccount modal={modal} setModal={setModal} userInfo={userInfo} userName={userName}/>:
                            modal === 3 &&<ModalAccount modal={modal} setModal={setModal} userInfo={userInfo} userName={userName}/>}
                        {modal === 4 &&


                             <ModalPosts modal={modal} setModal={setModal} userInfo={userInfo} counts={counts}
                                        type={type} activePost={activePost} deleteActivePost={deleteActivePost}
                                        setActivePost={setActivePost} errorMessage={errorMessage}
                                        sendOrder={sendOrder} service={service} priceValue={priceValue}/>}
                        {modal === 5 && <ModalPayment modal={modal} setModal={setModal} result={result} counts={counts} service={service} priceValue={priceValue} isLoading={isLoading} />}
                ...
                :
                    <div className={styles.modal_container}>
                        ...
                        <img src="/modalClose.svg" className={styles.close} onClick={() => setOpen(false)}/>
                        {modal === 1 &&
                            <ModalEmail modal={modal} setModal={setModal} counts={counts} priceValue={priceValue}
                                        service={service} setUserEmail={setUserEmail} userEmail={userEmail}
                                        getPosts={sendAdditionalOrder} errorMessage={errorMessage} system={system}/>}

                        {modal === 2 && <ModalPayment modal={modal} setModal={setModal} result={result} priceValue={priceValue}/>}
