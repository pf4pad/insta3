...
const Reviews = ({type,name,stars,text}) => {
    ...
    return (
        <div className={buyLikesStyles.reviews_comments_item}>
            <div className={`${styles.itemAvatar} ${type === 'youtube' ? styles.youtube : ''} ${type === 'instagram' ? styles.instagram : ''} ${type === 'twitter' ? styles.twitter : ''} ${type === 'tiktok' ? styles.tiktok : ''} ${type === 'facebook' ? styles.facebook : ''} ${type === 'spotify' ? styles.spotify : ''} ${type === 'vk' ? styles.vk : ''}`}>
                <p>A</p>
            </div>
